...
const RARITY_CLASS: Record<string, string> = {
  ...
  legendary: 'border-amber-400/50 bg-amber-400/10 shadow-[0_0_24px_rgba(245,158,11,0.15)]',
};
...
export default function CardsPageContent() {
  ...
  return (
    <LandingPublicLayout title={t('cards.meta_title')}>
      <Reveal>
        <Heading
          as="h1"
          size="7"
      ...
      {charactersQuery.data ? (
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.4fr)]">
          <Reveal delay={0.05}>
                  ...
                  {characterCardsQuery.data.cards.map(card => (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        {card.description ? (
                          <Text as="p" size="1" color="gray" className="line-clamp-3">
                            {card.description}
                          </Text>
                        ) : null}
